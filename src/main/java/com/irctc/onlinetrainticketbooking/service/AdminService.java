	...
	public ResponseStructure<Admin> loginWithAdmin(String adminName,String adminPassword) {
		...
		if(admin!=null) {
			if((admin.getAdminName().equals(adminName))
				...
				responseStructure.setMessage("Admin----LoggedIn----Successfully...");
				...
				responseStructure.setMessage("Admin----LoggedIn----Failed...");
			...
			responseStructure.setStatusCode(HttpStatus.NOT_FOUND.value());
			responseStructure.setMessage("Admin----Details not found...");
